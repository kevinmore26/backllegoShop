...
class ProductoModel(models.Model):
    ...
    productoTipo = models.CharField(db_column='productoTipo',max_length=10 ,null=False, choices=TIPO_PRODUCTO,default="1")
    
    productoSubTipo = models.CharField(db_column='productoSubTipo',max_length=10,default="kfc")
...
class clienteModel(AbstractBaseUser, PermissionsMixin):
    ...
    clienteDocumento = models.CharField(
         db_column='documento',max_length=9,unique=False,null=True
    )
